...
$(document).click(function(e) {
  var recipePopup = $('.fish-info--show');
  var clickOnPopup = e.target.closest('.fish-info--show');

  if (recipePopup.length && !clickOnPopup) {
    recipePopup.removeClass('fish-info--show');
  }
});
...
$('.fish-info__btn').click(function() {
  $(this).parent().parent().toggleClass('fish-info--show');
    
  $(".fish-info__table").getNiceScroll().resize();
});

$('input[type="file"]').change(function (event, files, label) {
...
$('.review__more').click(function() {
	var reviewText = $(this).parent().find(".review__info").toggleClass('review__info_full');
    if (reviewText.hasClass("review__info_full")) {
      this.innerHTML = "-";
    } else {
      this.innerHTML = "+";
    }
