(function($) {
    ...
    var getCityStockBy = function(country, number) {
        switch (country) {
            case 'at': // Австрия
                return ['Вена','Линц','Инсбрук','Зальцбург','Инсбрук','Фельдкирх','Брегенц','Баден','Хоэнемс','Лиенц'][number - 1];
                break;
            case 'bg': // Болгария
                return ['София','Пловдив ','Варна','Бургас','Шумен','Дупница','Перник','Хасково','Велинград','Петрич'][number - 1];
                break;
            case 'hu': // Венгрия
                return ['Будапешт ','Кечкемет','Мишкольц ','Сольнок','Веспрем','Шольт','Сечень','Путнок','Сольнок','Тамаши'][number - 1];
                break;
            case 'de': // Германия
                return ['Дрезден','Гамбург','Мюнхен','Штутгарт','Берлин','Оффенбах','Йена','Кобленц','Дюрен','Люнен'][number - 1];
                break;
            case 'gr': // Греция
                return ['Афины','Каламата','Ханья','Пирей','Патры','Калитея','Козани','Ксанти','Пиргос','Килкис'][number - 1];
                break;
            case 'es': // Испания
                return ['Мадрид','Барселона','Валенсия','Мурсия','Сарагоса','Гранада','Картахена','Витория','Сабадель','Аликанте'][number - 1];
                break;
            case 'it': // Италия
                return ['Рим','Флоренция','Неаполь','Мессина','Милан','Фоджа','Монца','Виченца','Пескара','Феррара'][number - 1];
                break;
            case 'cy': // Кипр
                return ['Лимасол','Ларнака','Фамагуста','Строволос','Пафос','Кирения','Дикомо','Протарас','Лефка','Лапитос'][number - 1];
                break;
            case 'lv': // Латвия
                return ['Рига','Елгава','Валмиера','Юрмала','Тукумс','Валка','Лудза','Алуксне','Медуми','Сигулда'][number - 1];
                break;
            case 'lt': // Литва
                return ['Вильнюс','Йонава','Каунас','Утена','Алитус','Варена','Пасвалис','Паланга','Молетай','Биржай'][number - 1];
                break;
            case 'pl': // Польша
                return ['Варшава','Познань','Лодзь','Белосток','Краков','Бохня','Кельце','Плоцк','Кошалин','Браньск'][number - 1];
                break;
            case 'pt': // Португалия
                return ['Лиссабон','Порту','Лореш','Амадора','Брага','Элваш','Келуш','Сакавен','Борба','Серпа'][number - 1];
                break;
            case 'ro': // Румыния
                return ['Бухарест','Яссы','Констанца','Брашов','Крайова','Александрия','Борша','Бистрица','Куджир','Зимнича'][number - 1];
                break;
            case 'sk': // Словакия
                return ['Братислава','Мартин','Жилина','Кошице','Гуменне','Середь','Сеница','Битча','Модра','Рожнява'][number - 1];
                break;
            case 'fr': // Франция
                return ['Париж','Ницца','Марсель','Лимож','Бордо','Брест','Нарбон','Кайенна','Руан','Бельфор'][number - 1];
                break;
            case 'hr': // Хорватия
                return ['Загреб','Пула','Риека','Вараждин','Дубровник','Чаковец','Сисак','Самобор','Осиек','Сплит'][number - 1];
                break;
            case 'cz': // Чехия
                return ['Прага','Пльзень','Либерец','Оломоуц','Пардубице','Трутнов','Вишков','Кадань','Годонин','Брунталь'][number - 1];
                break;
            case 'ee': // Эстония
                return ['Таллин','Нарва','Тарту','Пярну','Пярну','Пылва','Валга','Кейла','Тюри','Тырва'][number - 1];
                break;
            default:
                return 'Unknown';
        }
    ...
    var getCityMoreBy = function(country, number) {
        switch (country) {
            case 'at': // Австрия
                return ['Дрезден','София','Будапешт ','Мадрид','Рига','Прага','Краков','Бухарест','Марсель','Неаполь','Рим','Афины'][number - 1];
                break;
            case 'bg': // Болгария
                return ['Дрезден','Вена','Будапешт ','Мадрид','Рига','Прага','Краков','Бухарест','Марсель','Неаполь','Рим','Афины'][number - 1];
                break;
            case 'hu': // Венгрия
                return ['Дрезден','Вена','Йонава','Мадрид','Рига','Прага','Краков','Бухарест','Марсель','Неаполь','Рим','Афины'][number - 1];
                break;
            case 'de': // Германия
                return ['Варшава','Вена','Будапешт ','Мадрид','Рига','Прага','Краков','Бухарест','Марсель','Неаполь','Рим','Афины'][number - 1];
                break;
            case 'gr': // Греция
                return ['Дрезден','Вена','Будапешт ','Мадрид','Рига','Прага','Краков','Бухарест','Марсель','Неаполь','Рим','Лиссабон'][number - 1];
                break;
            case 'es': // Испания
                return ['Дрезден','Вена','Будапешт ','Лодзь','Рига','Прага','Краков','Бухарест','Марсель','Неаполь','Рим','Афины'][number - 1];
                break;
            case 'it': // Италия
                return ['Дрезден','Вена','Будапешт ','Мадрид','Рига','Прага','Краков','Бухарест','Марсель','Таллин','Варна','Афины'][number - 1];
                break;
            case 'cy': // Кипр
                return ['Дрезден','Вена','Будапешт ','Мадрид','Рига','Прага','Краков','Бухарест','Марсель','Неаполь','Рим','Афины'][number - 1];
                break;
            case 'lv': // Латвия
                return ['Дрезден','Вена','Будапешт ','Мадрид','Мюнхен','Прага','Краков','Бухарест','Марсель','Неаполь','Рим','Афины'][number - 1];
                break;
            case 'lt': // Литва
                return ['Дрезден','Вена','Будапешт ','Мадрид','Рига','Прага','Краков','Бухарест','Марсель','Неаполь','Рим','Афины'][number - 1];
                break;
            case 'pl': // Польша
                return ['Дрезден','Вена','Будапешт ','Мадрид','Рига','Прага','Лиссабон','Бухарест','Марсель','Неаполь','Рим','Афины'][number - 1];
                break;
            case 'pt': // Португалия
                return ['Дрезден','Вена','Будапешт ','Мадрид','Рига','Прага','Краков','Бухарест','Марсель','Неаполь','Рим','Афины'][number - 1];
                break;
            case 'ro': // Румыния
                return ['Дрезден','Вена','Будапешт ','Мадрид','Рига','Прага','Краков','Ницца','Марсель','Неаполь','Рим','Афины'][number - 1];
                break;
            case 'sk': // Словакия
                return ['Дрезден','Вена','Будапешт ','Мадрид','Рига','Прага','Краков','Бухарест','Марсель','Неаполь','Рим','Афины'][number - 1];
                break;
            case 'fr': // Франция
                return ['Дрезден','Вена','Будапешт ','Мадрид','Рига','Прага','Краков','Бухарест','Барселона','Неаполь','Рим','Афины'][number - 1];
                break;
            case 'hr': // Хорватия
                return ['Дрезден','Вена','Будапешт ','Мадрид','Рига','Прага','Краков','Бухарест','Марсель','Неаполь','Рим','Афины'][number - 1];
                break;
            case 'cz': // Чехия
                return ['Дрезден','Вена','Будапешт ','Мадрид','Рига','Милан','Краков','Бухарест','Марсель','Неаполь','Рим','Афины'][number - 1];
                break;
            case 'ee': // Эстония
                return ['Дрезден','Вена','Будапешт ','Мадрид','Рига','Прага','Краков','Бухарест','Марсель','Неаполь','Рим','Афины'][number - 1];
                break;
    ...
    var init = function(config)
    {
        ...
        // Stock
        for(let i = 1; i <= 10; i++) {
            $('.pl_city_stock' + i).text(getCityStockBy(currentCountry, i));
        }

        // More
        for(let i = 1; i <= 12; i++) {
            $('.pl_city_more' + i).text(getCityMoreBy(currentCountry, i));
        }
